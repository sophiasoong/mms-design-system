...
/** Provided illustration asset. Its brand-colored fills sit exactly on the brand-primary scale
    (300 tray, 50 sheet, 100 folder, 600 face) in both the MMS and the MMA export, so they are
    resolved through the scale tokens and follow the MMS/MMA toggle on their own. The speech
    bubble is brand-secondary-300 in both exports. The ground shadow (#F5F5F7 @ 0.8) is
    identical in both exports too — flagged: no brand-neutral palette token exists for it, so
    it stays the asset's own literal color. */
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="var(--brand-primary-300)" /* color/brand/primary/300 */
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="var(--brand-primary-50)" /* color/brand/primary/50 */
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="var(--brand-primary-100)" /* color/brand/primary/100 */
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="var(--brand-secondary-300)" /* color/brand/secondary/300 */
      />
      {/* Face: color/brand/primary/600 */}
      <rect x="102.25" y="11" width="2.625" height="3" fill="var(--brand-primary-600)" />
      <ellipse cx="108.463" cy="12.6" rx="1.4" ry="1.6" fill="var(--brand-primary-600)" />
      <path d="M98.5312 11L100.062 14H97L98.5312 11Z" fill="var(--brand-primary-600)" />
    </svg>
  );
}

...
/* Traced from the user-provided Lightbox.svg (96x96): the rounded-frame outline and its two
   inner bars (#BFBFBF) are the fixed lightbox-body mark -> --brand-neutral-600; the two
   chevron arrows (black stroke) are the active/detail mark -> currentColor, matching this
   file's two-tone convention. */
export function LightboxIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="24" height="24" viewBox="0 0 96 96" fill="none" aria-hidden="true">
      <path
        d="M72 12C80.8366 12 88 19.1634 88 28V68C88 76.6984 81.0587 83.776 72.4131 83.9951L72 84H24L23.5869 83.9951C15.0785 83.7795 8.2205 76.9215 8.00488 68.4131L8 68V28C8 19.1634 15.1634 12 24 12H72ZM24 20C19.5817 20 16 23.5817 16 28V68C16 72.4183 19.5817 76 24 76H72C76.4183 76 80 72.4183 80 68V28C80 23.5817 76.4183 20 72 20H24Z"
        fill="var(--brand-neutral-600)"
      />
      <path
        d="M33 36C33 33.7909 34.7909 32 37 32H59C61.2091 32 63 33.7909 63 36V52C63 54.2091 61.2091 56 59 56H37C34.7909 56 33 54.2091 33 52V36Z"
        fill="var(--brand-neutral-600)"
      />
      <path
        d="M33 66C33 63.7909 34.7909 62 37 62H59C61.2091 62 63 63.7909 63 66V66C63 68.2091 61.2091 70 59 70H37C34.7909 70 33 68.2091 33 66V66Z"
        fill="var(--brand-neutral-600)"
      />
      <path d="M69 38L75 44L69 50" stroke="currentColor" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M27 38L21 44L27 50" stroke="currentColor" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

/* Traced from the user-provided Upload.svg (96x96): the cloud outline (#BFBFBF) is the
   fixed container mark -> --brand-neutral-600 (exact hex match); the upward arrow
   (#222222) is the active/detail mark -> currentColor, matching this file's two-tone
   convention. */
export function UploadIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="24" height="24" viewBox="0 0 96 96" fill="none" aria-hidden="true">
      <path
        d="M74 72H63C60.7909 72 59 73.7909 59 76C59 78.2091 60.7909 80 63 80H74C79 80 83.25 78.25 86.75 74.75C90.25 71.25 92 67 92 62C92 57.4 90.4833 53.3833 87.45 49.95C84.4167 46.5167 80.6 44.5333 76 44C76 36.2 73.2833 29.5833 67.85 24.15C62.4167 18.7167 55.8 16 48 16C41.6667 16 36 17.9 31 21.7C26 25.5 22.6667 30.4667 21 36.6C15.9333 37.7333 11.8333 40.3333 8.7 44.4C5.56667 48.4667 4 53.1 4 58.3C4 64.3667 6.15 69.5 10.45 73.7C14.75 77.9 19.9333 80 26 80H32C33.1333 80 34.0833 79.6167 34.85 78.85C35.6167 78.0833 36 77.1333 36 76C36 74.8667 35.6167 73.9167 34.85 73.15C34.0833 72.3833 33.1333 72 32 72H26C22.1333 72 18.8333 70.6333 16.1 67.9C13.3667 65.1667 12 61.8667 12 58C12 54.1333 13.3667 50.8333 16.1 48.1C18.8333 45.3667 22.1333 44 26 44H28C28 38.4667 29.95 33.75 33.85 29.85C37.75 25.95 42.4667 24 48 24C53.5333 24 58.25 25.95 62.15 29.85C66.05 33.75 68 38.4667 68 44V52H74C76.8 52 79.1667 52.9667 81.1 54.9C83.0333 56.8333 84 59.2 84 62C84 64.8 83.0333 67.1667 81.1 69.1C79.1667 71.0333 76.8 72 74 72Z"
        fill="var(--brand-neutral-600)"
      />
      <path
        d="M39.7 55.3L43.3 51.8V72.4V76.4003C43.3 78.6094 45.0909 80.4 47.3 80.4C49.5091 80.4 51.3 78.6091 51.3 76.4V72.4V51.8L54.9 55.3C55.7 56.0333 56.65 56.3833 57.75 56.35C58.85 56.3167 59.7667 55.9333 60.5 55.2C61.3 54.4 61.6833 53.45 61.65 52.35C61.6167 51.25 61.2333 50.3333 60.5 49.6L50.1 39.2C49.3 38.4 48.3667 38 47.3 38C46.2333 38 45.3 38.4 44.5 39.2L34.1 49.6C33.3667 50.3333 33 51.2667 33 52.4C33 53.5333 33.3667 54.4667 34.1 55.2C34.9 56 35.85 56.4 36.95 56.4C38.05 56.4 38.9667 56.0333 39.7 55.3Z"
        fill="currentColor"
      />
    </svg>
  );
...
/* The Upload dropzone's own glyph (Figma-exported, not a nav icon) — a single flat
   fill, #1E1E1E, an exact match for --interactive-dropzone-icon-default, so it maps to
   currentColor and takes its color from that token via CSS rather than a hardcoded fill.
   Native 48×48 viewBox, rendered at 48×48 to match the dropzone's glyph size exactly. */
export function DropzoneIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
      <path
        d="M24.3382 21.1643C24.2981 21.1131 24.2469 21.0717 24.1884 21.0432C24.1299 21.0147 24.0657 20.9999 24.0007 20.9999C23.9356 20.9999 23.8714 21.0147 23.813 21.0432C23.7545 21.0717 23.7033 21.1131 23.6632 21.1643L17.6632 28.7554C17.6137 28.8186 17.583 28.8944 17.5746 28.9741C17.5662 29.0539 17.5804 29.1345 17.6156 29.2066C17.6508 29.2787 17.7056 29.3394 17.7737 29.3818C17.8418 29.4242 17.9205 29.4466 18.0007 29.4465H21.9596V42.4322C21.9596 42.6679 22.1525 42.8607 22.3882 42.8607H25.6025C25.8382 42.8607 26.031 42.6679 26.031 42.4322V29.4518H30.0007C30.3596 29.4518 30.5578 29.0393 30.3382 28.7607L24.3382 21.1643Z"
        fill="currentColor"
      />
      <path
...
export function ModalIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="24" height="24" viewBox="0 0 96 96" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M23 34C23 31.7909 24.7909 30 27 30H47C49.2091 30 51 31.7909 51 34V34C51 36.2091 49.2091 38 47 38H27C24.7909 38 23 36.2091 23 34V34Z"
        fill="var(--brand-neutral-600)"
      />
      <path
        d="M23 52C23 49.7909 24.7909 48 27 48H69C71.2091 48 73 49.7909 73 52V52C73 54.2091 71.2091 56 69 56H27C24.7909 56 23 54.2091 23 52V52Z"
        fill="var(--brand-neutral-600)"
      />
      <path
        d="M68.3788 26.8788C69.5503 25.7072 71.4494 25.7072 72.621 26.8788C73.7924 28.0503 73.7925 29.9494 72.621 31.1209L69.3212 34.4198L72.6698 37.9286C73.8137 39.1271 73.7696 41.0258 72.5712 42.1698C71.3727 43.3137 69.474 43.2695 68.3299 42.0711L65.077 38.6639L62.121 41.6209C60.9494 42.7925 59.0504 42.7924 57.8788 41.6209C56.7072 40.4494 56.7072 38.5503 57.8788 37.3788L60.9335 34.3231L57.8299 31.0711C56.6859 29.8726 56.7301 27.974 57.9286 26.8299C59.1271 25.6859 61.0258 25.7301 62.1698 26.9286L65.1776 30.079L68.3788 26.8788Z"
        fill="currentColor"
      />
      <path
        d="M55 66C55 63.7909 56.7909 62 59 62H69C71.2091 62 73 63.7909 73 66V66C73 68.2091 71.2091 70 69 70H59C56.7909 70 55 68.2091 55 66V66Z"
        fill="currentColor"
      />
      <path
        d="M33 66C33 63.7909 34.7909 62 37 62H47C49.2091 62 51 63.7909 51 66V66C51 68.2091 49.2091 70 47 70H37C34.7909 70 33 68.2091 33 66V66Z"
        fill="currentColor"
      />
    </svg>
  );
...
export function AssetsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="24" height="24" viewBox="0 0 96 96" fill="none" aria-hidden="true">
      <path
        d="M16 80C13.8 80 11.9167 79.2167 10.35 77.65C8.78333 76.0833 8 74.2 8 72V24C8 21.8 8.78333 19.9167 10.35 18.35C11.9167 16.7833 13.8 16 16 16H38.3431C39.404 16 40.4214 16.4214 41.1716 17.1716L47.4142 23.4142C47.7893 23.7893 48.298 24 48.8284 24H80C82.2 24 84.0833 24.7833 85.65 26.35C87.2167 27.9167 88 29.8 88 32V72C88 74.2 87.2167 76.0833 85.65 77.65C84.0833 79.2167 82.2 80 80 80H16ZM16 70C16 71.1046 16.8954 72 18 72H78C79.1046 72 80 71.1046 80 70V34C80 32.8954 79.1046 32 78 32H45.5284C44.998 32 44.4893 31.7893 44.1142 31.4142L37.2858 24.5858C36.9107 24.2107 36.402 24 35.8716 24H18C16.8954 24 16 24.8954 16 26V70Z"
        fill="var(--brand-neutral-600)"
      />
      <path
        d="M68.8735 64H27.1499C24.6506 64 23.2471 61.123 24.7856 59.1533L33.2212 48.3533C34.4206 46.8177 36.7427 46.8151 37.9456 48.348L43.159 54.992C43.5607 55.5039 44.3367 55.5019 44.7357 54.9879L54.0002 43.0529C55.2012 41.5056 57.5388 41.5056 58.7398 43.0529L71.2433 59.1604C72.7733 61.1314 71.3686 64 68.8735 64Z"
        fill="currentColor"
      />
    </svg>
  );
